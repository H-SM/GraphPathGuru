...
const Navbar = () => {
  return (
    ...
    <a class="flex-none text-slate-900" href="/"><span class="sr-only">Graph Path Guru</span>
    ...
    <div class="ml-auto hidden lg:flex lg:items-center">
      ...
      <a class="ml-8" href="/aboutUs">Our Team</a>
      <a class="ml-8" href="/documentation">Docs</a>
    </div>
    ...
    <div class="hidden lg:ml-8 lg:flex lg:items-center lg:border-l lg:border-slate-900/15 lg:pl-8">
      ...
      <a class="inline-flex justify-center rounded-lg text-sm font-semibold py-2.5 px-4 bg-slate-900 text-white hover:bg-slate-700 -my-2.5 ml-8" href="/documentations#start"><span>How to start <span aria-hidden="true">→</span></span></a></div></div></nav></header>
    </>

        ...
        <> 
          ...
          <div class="text-center text-gray-500 dark:text-gray-400">
              ...
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900">
                  <a href="#">Harman Singh Malhotra</a>
              </h3>
              <p>CEO/Co-founder</p>
          ...
          <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="https://avatars.githubusercontent.com/u/97795121?v=4" alt="akshat"/>
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900">
                  <a href="#">Akshat Kapil</a>
              </h3>
              <p>CEO/Co-founder</p>
              <ul class="flex justify-center mt-4 space-x-4">

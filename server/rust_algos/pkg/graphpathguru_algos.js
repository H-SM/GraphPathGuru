/* @ts-self-types="./graphpathguru_algos.d.ts" */
 ...
 * @returns {string}
 */
function run_bellman_ford(v, adj, source) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.run_bellman_ford(v, adj, source);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
...
exports.run_bellman_ford = run_bellman_ford;
 ...
 * @returns {string}
 */
function run_dijkstra(v, adj, source) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.run_dijkstra(v, adj, source);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
exports.run_floyd_warshall = run_floyd_warshall;
 ...
 * @returns {string}
 */
function run_johnson(v, adj) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.run_johnson(v, adj);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
exports.run_johnson = run_johnson;
 ...
 * @returns {string}
 */
function run_spfa(v, adj, source) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.run_spfa(v, adj, source);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
function run_yen(v, adj, source, dest, k) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.run_yen(v, adj, source, dest, k);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./graphpathguru_algos_bg.js": import0,
    };
}
...
const wasmPath = `${__dirname}/graphpathguru_algos_bg.wasm`;
